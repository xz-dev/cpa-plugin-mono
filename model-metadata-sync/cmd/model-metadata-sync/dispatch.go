	...
	return registration{
		...
		Metadata: pluginapi.Metadata{
			...
			ConfigFields: []pluginapi.ConfigField{
				{Name: "config_file", Type: pluginapi.ConfigFieldTypeString, Description: "Path to model-metadata-sync JSON config. Default plugins/model-metadata-sync/config.json"},
			},
		},
